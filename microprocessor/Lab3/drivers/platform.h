...
//#define GET_PORT(pin) ((GPIO_TypeDef*)(APB2PERIPH_BASE + 0x0400 * GET_PORT_INDEX(pin)))
#define GET_PORT(pin) ((GPIO_TypeDef*)(GPIOA_BASE + 0x0400 * GET_PORT_INDEX(pin)))
